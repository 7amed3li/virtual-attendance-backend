...
model ders_kayitlari {
  ...
  kullanicilar kullanicilar @relation(name: "OgrenciDersKayitlari", fields: [universite_kodu], references: [universite_kodu], onDelete: Cascade, onUpdate: NoAction)

  @@unique([ders_id, universite_kodu])
}
